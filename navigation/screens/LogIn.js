    ...
    const handleRegistration = async () => {
        ...
        try {
            ...
            await setDoc(doc(db, "users", user.uid), {
                ...
                firstName: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
                lastName: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
                major: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
                year: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
                studyStyles: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
                locationPrefs: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
                areasToImprove: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
                shortTermGoals: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
                longTermGoals: '', // Ä¬ÈÏÎª¿Õ×Ö·û´®
